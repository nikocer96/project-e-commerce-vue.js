...
<template>
  <main class="bg-[#0a1128] w-full h-full">
    <!-- Sezione prodotti -->
    <section class="p-[24px]">
      <h1 class="text-white">lista dei prodotti</h1>
      <ul class="grid grid-cols-2 gap-6 md:grid-cols-3 lg:grid-cols-4">
        <li v-for="prodotto in prodotti">
          <div class="bg-[#fefcfb] border-2 rounded-2xl flex flex-col items-center justify-center p-[8px]">
            ...
            <img :src="prodotto.image" :alt="prodotto.title" class="object-size-down h-[150px] md:h-[200px] lg:h[350px]">
