...
<template>
  <nav class="overflow-x-hidden">
    <div class="flex h-[100px] bg-[#0a1128] text-white justify-between items-center p-[10px]">
      <div class="mr-[10px]">
        <RouterLink to="/">
          <img class="h-[60px] w-[70px] md:max-w-none md:h-[100px] md:w-[100px]" src="../assets/logo5.png" alt="logo-e-commerce">
        </RouterLink>
      </div>
      ...
      <div>
        <div class="flex justify-center items-center">
          <div>
            <ul class="flex">
              <li>
                <RouterLink to="/about" class=" text-xl font-serif hover:text-2xl max-[600px]:mr-[10px] ml-[20px] border-[1px] border-white rounded-md p-[7px]">
                  About us
                </RouterLink>
              </li>
            </ul>
          ...
          <form class="flex justify-end items-center">
            <div class="hidden max-[600px]:flex">
              <RouterLink to="#">
                <img class="h-[30px] w-[30px] mt-[5px] mr-[20px] rounded-sm" src="../assets/lente.svg" alt="immagine-lente-ricerca">
              </RouterLink>
            </div>
            <input class="hidden min-[600px]:flex w-[100%] h-[100%] ml-[15px] mr-[10px] rounded-[20px]" type="text" placeholder="Ricerca">
          </form>
          <div class="hidden min-[730px]:flex justify-center items-center">
            <div>                        
              <div v-if="isLoggedIn">                           
                ...
                <RouterLink to="/carrello" class="ml-[10px] border-[1px] border-white rounded-md p-[7px] text-xl font-serif font-semibold" @click="updateQuantita">
                  Carrello <span class="bg-white w-[30px] h-[30px] text-black text-center rounded-[50%]">{{ quantita }}</span>
                </RouterLink>
              </div>                         
              <div v-else>                             
          ...
          <div class="hidden max-[730px]:flex">
            ...
            <div v-if="isDropdownOpen" class="absolute mt-1 bg-white border rounded-md shadow-md z-20">
              <div v-if="isLoggedIn">
                ...
                <button class="w-[80px] h-[30px] border-[1px] border-white rounded-md p-[7px] text-black text-xl font-serif font-semibold" @click="updateQuantita">
